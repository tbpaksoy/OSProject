...
namespace OSProject
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            storage.AddSearchTerms("Name", "Win32_DiskDrive");//Disk Adı 9
            storage.AddSearchTerms("Model", "Win32_DiskDrive");//Disk Modeli 10
            storage.AddSearchTerms("Manufacturer", "Win32_DiskDrive");//Disk üretici 11
            storage.AddSearchTerms("Partitions", "Win32_DiskDrive");//Disk bölümlenmesi 12
            storage.AddSearchTerms("Size", "Win32_DiskDrive");//Disk boyutı(byte) 19
            ...
            label9.Text += storageData[0] + "\n";
            label10.Text += storageData[1] + "\n";
            label11.Text += storageData[2] + "\n";
            label12.Text += storageData[3] + "\n";
            label19.Text += storageData[4] + "\n";
