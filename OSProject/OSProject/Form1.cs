...
namespace OSProject
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            ram.AddSearchTerms("NumberOfCores", "Win32_Processor");
            ram.AddSearchTerms("Name", "Win32_Processor");
            ram.AddSearchTerms("MaxClockSpeed", "Win32_Processor");
            ram.AddSearchTerms("NumberOfLogicalProcessors", "Win32_Processor");
            label1.Text = null;
            label2.Text = null;
            label3.Text = null;
            label4.Text = null;
            ...
            hardware2.AddSearchTerms("Layout", "Win32_Keyboard");
            label8.Text = null;
